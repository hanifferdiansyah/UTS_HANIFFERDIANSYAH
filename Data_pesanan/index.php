            ...
            <div class="col-8 m-auto">
                <div class="card">
                    <div class="card-header">
                        <h3 class="float-start">Data Pesanan</h3>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-success btn-sm" href="edit.php?id=<?= $data['id_pesanan'] ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="hapus.php?id_pesanan=<?=$data['id_pesanan']?>" class="btn btn-danger">HAPUS</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
